...
function App() {
	return (
		<>
		<Navbar />
			<div className="h-screen overflow-scroll snap-y-scroll -z-10 scroll-smooth">
				<Hero />

				<section id="MojeHobby" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
				...
				<section id="o-mnie" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
					<Element title="OMnie" />
				...
				<section id="JezykHTML" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
				...
				<section id="PonadHTML" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
					<Element title="PonadHTML" />
					<PonadHTML />
				</section>

				<section id="WiekszeMozliwosci" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
					<Element title="WiększeMożliwości" />
					<WiekszeMozliwosci />
				</section>

				<section id="Framework" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
				...
				<section id="ReactJs" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
				...
				<section id="Runtime" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
				...
				<section id="Koniec" className="pt-12 md:pt-4 text-center relative snap-start overflow-y-hidden h-screen">
